...
\section{Credito Extra}

El benchmark se ejecuta de nuevo sobre el set de 'Test' (de acuerdo a las observaciones recibidas despues de la entrega) de la BSDS-500. Se utilizan los algoritmos clustering: GMM, Hierachical cluster y KMeans, y se corren unicamente el espacio de color HSV+xy. Adicionalmente se utiliza un K entre 2 y 15 para mejorar un poco los resultados de la segmentación.
...
HSV+xy Hierachical & F( 0.66, 0.47 ) = 0.55  & F( 0.71, 0.51 ) = 0.59 &  0.33\\
\end{tabular}
\label{table:thetable2}
\end{table*}


En la tabla \ref{table:thetable2} y se puede observar que el desempeño de los metodos mejora ligeramente comoarado con la tabla \ref{table:thetable}, este resultado se debe principalmente a que se tiene 2 clusters extra (K va hasta 15) que posiblemente mejoran el desempeño en imagenes que tienen mas de 13 objetos.
