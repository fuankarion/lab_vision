...
Metodo & ODS & OID & AreaPR  \\
\hline	
HSV+xy GMM & F( 0.78, 0.40 ) = 0.53  & F( 0.80, 0.47 ) = 0.59 & 0.27 \\
HSV+xy KMeans & F( 0.78, 0.39 ) = 0.50  &  F( 0.81, 0.46 ) = 0.58 &  0.27\\
HSV+xy Hierachical & F( 0.72, 0.70 ) = 0.71  & F( 0.77, 0.71 ) = 0.74 &  0.73\\
\end{tabular}
